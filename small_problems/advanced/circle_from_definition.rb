# Draws an ascii circle based on the definition of a circle
# as the set of all points equidistant from the center point
# We need to map discrete points on the ascii grid as approximations
# of the equidistant points in continuous geometric space
