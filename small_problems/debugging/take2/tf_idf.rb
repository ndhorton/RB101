...
def idf(term, documents)
  ...
  # Further exploration
  # There is a divide by zero problem here, though I'm not sure what
  # to do in the event that the term doesn't appear in any document
  # -- return 0?
  # The division would produce infinity -- or NaN (if there are
  # no documents in the collection either) 
